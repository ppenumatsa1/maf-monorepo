...
if grep -Eq '^(\.github/workflows/foundry-.*\.yml|infra/foundry-hosted/|backend/foundry/main\.py|backend/Dockerfile\.hosted|scripts/foundry/|scripts/github/foundry_hosted_e2e\.sh)' <<<"$changed_files"; then
